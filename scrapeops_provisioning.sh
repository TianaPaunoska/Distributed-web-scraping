...
#Step 1 complete
provisionPing server-vm 458022 1
...
##### Step 2 complete #####
provisionPing server-vm 458022 2
...
echo TestServer > /etc/hostname sed -i 's/127.0.0.1.*localhost/127.0.0.1 TestServer.localdomain TestServer localhost/' /etc/hosts hostname TestServer 
...
PASSWORD=$(mkpasswd -m sha-512 b8f660054a5d7aa0) 
...
#Step 3 complete
provisionPing server-vm 458022 3


# Configure Git Settings
git config --global user.name "Tiana" && git config --global user.email "tiana.paunoska@gmail.com"
...
# Step 4 complete 
provisionPing server-vm 458022 4
...
provisionPing server-vm 458022 5
